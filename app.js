...
document.getElementById("potDisplay").textContent=`$${baseWager*carryCount*multiplier}/player`;
...
players.forEach(p=>wrap.innerHTML+=`<button onclick="sidePlayer('${p}')">${p}</button>`);
}
