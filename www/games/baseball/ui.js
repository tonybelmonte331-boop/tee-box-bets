registerGameUI("baseball", {
  ...
  finishHole() {
    ...
    // 1v1: use individual scores directly
    // 2v2: use combined (total) strokes per team
    const scoreA = is1v1 ? a1 : (a1 + a2);
    const scoreB = is1v1 ? b1 : (b1 + b2);
    ...
    GAME_ENGINES.baseball.recordHole(
      hole, scoreA, scoreB, birdie, baseWager, teams, ledger
    );
